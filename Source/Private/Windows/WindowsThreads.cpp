...
NativeThreadHandle WindowsThreads::CreateThread(
    NativeThreadId& out_thread_id, NativeThreadFunctionPtr function, ThreadArgsPtr args, bool start_suspended /*= false*/)
{
    DWORD              ThreadId;
