...
class OutputDeviceManager
{
  public:
    ...
    template<typename T, typename... Args> void RegisterOutputDevice(Args&&... args);
...
template<typename T, typename... Args> inline void OutputDeviceManager::RegisterOutputDevice(Args&&... args)
{
