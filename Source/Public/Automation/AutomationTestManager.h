...
class AutomationTestManager
{
  public:
    ...
    template<typename TTestType, typename... Args> static void RegisterStartupTest(Name name, Args... arguments);
...
template<typename TTestType, typename... Args> inline void AutomationTestManager::RegisterStartupTest(Name name, Args... arguments)
{
...
template<typename TTestType> struct AutoStartupTest
{
  public:
    template<typename... Args> AutoStartupTest(Name name, Args... arguments)
    {
...
#define DEFINE_AUTOMATION_STARTUP_TEST(Name, Type, ...)                                                                                                        \
    namespace                                                                                                                                                  \
    {                                                                                                                                                          \
    Zn::Automation::AutoStartupTest<Type> Name##TestInstance {#Name, __VA_ARGS__};                                                                             \
    }